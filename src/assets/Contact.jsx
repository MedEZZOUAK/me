        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            {state.succeeded ? (
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-2">Thank you!</h3>
          ...
          >
            <div className="bg-white/80 dark:bg-dark-card backdrop-blur-sm p-8 rounded-2xl border border-gray-200 dark:border-dark-border shadow-xl">
                <h3 className="text-3xl font-semibold text-slate-800 dark:text-gray-200 mb-6">Get In Touch</h3>
            ...
            <div className="bg-white/80 dark:bg-dark-card backdrop-blur-sm p-8 rounded-2xl border border-gray-200 dark:border-dark-border shadow-xl">
              <h3 className="text-2xl font-semibold text-slate-800 dark:text-gray-200 mb-6">Connect With Me</h3>
